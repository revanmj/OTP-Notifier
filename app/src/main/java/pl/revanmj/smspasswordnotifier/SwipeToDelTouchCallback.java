...
public class SwipeToDelTouchCallback extends ItemTouchHelper.Callback {
    ...
    public void onSwiped(RecyclerView.ViewHolder viewHolder, int swipeDir) {
        int id = ((WhitelistAdapter.WhitelistItemHolder)viewHolder).getId();

        String selection = WhitelistProvider.KEY_ID + " = ?";
        String[] selArgs = {Integer.toString(id)};
        int count = context.getContentResolver().delete(WhitelistProvider.CONTENT_URI, selection, selArgs);
